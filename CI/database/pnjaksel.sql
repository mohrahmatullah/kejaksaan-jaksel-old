...
INSERT INTO `kabupaten` (`id_kabupaten`, `propinsi_id`, `nama_kabupaten`) VALUES
...
CREATE TABLE `setting` (
  `id` int(11) NOT NULL,
  `persentasi_hpp` float NOT NULL,
  `nominal_hpp` double NOT NULL,
  `persentasi_harga_distributor` float NOT NULL,
  `nominal_harga_distributor` double NOT NULL,
  `persentasi_harga_agen_a_plus` float NOT NULL,
  `nominal_harga_agen_a_plus` double NOT NULL,
  `persentasi_harga_agen_a` float NOT NULL,
  `nominal_harga_agen_a` double NOT NULL,
  `persentasi_harga_agen_b` float NOT NULL,
  `nominal_harga_agen_b` double NOT NULL,
  `persentasi_harga_agen_c` float NOT NULL,
  `nominal_harga_agen_c` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `setting` (`id`, `persentasi_hpp`, `nominal_hpp`, `persentasi_harga_distributor`, `nominal_harga_distributor`, `persentasi_harga_agen_a_plus`, `nominal_harga_agen_a_plus`, `persentasi_harga_agen_a`, `nominal_harga_agen_a`, `persentasi_harga_agen_b`, `nominal_harga_agen_b`, `persentasi_harga_agen_c`, `nominal_harga_agen_c`) VALUES
(1, 20, 0, 10, 0, 35, 0, 30, 0, 25, 0, 20, 0);
...
CREATE TABLE `sop` (
  ...
  `peraturan_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `verification` (
  ...
  `laporan` text,
  `file_before` varchar(255) DEFAULT NULL,
  `time_before` datetime DEFAULT NULL,
  `file_after` varchar(255) DEFAULT NULL,
  `time_after` datetime DEFAULT NULL,
  `approved_kasub` tinyint(1) NOT NULL DEFAULT '0',
  `approved_kasub_time` datetime DEFAULT NULL,
  `approved_kasie` tinyint(1) NOT NULL DEFAULT '0',
  `approved_kasie_time` datetime DEFAULT NULL,
  `approved_kajari` tinyint(1) NOT NULL DEFAULT '0',
  `approved_kajari_time` datetime DEFAULT NULL,
  `created_by` int(11) NOT NULL,
  `create_date` date NOT NULL,
  `update_by` int(11) NOT NULL,
  `update_date` date NOT NULL
