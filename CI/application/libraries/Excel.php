...
//            die();
            foreach ($data[0] as $key => $val) {
                ...
                $this->excel->getActiveSheet()->getStyle($col . '1')->getFill()->applyFromArray(array(
            ...
            foreach ($data as $row) {
                ...
                foreach ($row as $cell) {
                    ...
                    if ($col == 'A'){
                        $this->excel->getActiveSheet()->getColumnDimension($col)->setWidth(5);
                    }elseif($col == 'B'){
                        $this->excel->getActiveSheet()->getColumnDimension($col)->setWidth(13);
                    }else{
                        $this->excel->getActiveSheet()->getColumnDimension($col)->setWidth(30);
                    }
                    $col++;
                }
                $rowNumber++;
